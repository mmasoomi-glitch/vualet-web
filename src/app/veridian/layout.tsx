...
// the Veridian demo reads as one brand and invents no new palette.
...
export const metadata: Metadata = {
  title: "Veridian — sandboxed demo",
  description:
    "Ask Veridian anything it knows about the product. A read-only demo: it answers from a curated knowledge base and cannot take actions — a small illustration of grounded, no-hallucination AI.",
};
