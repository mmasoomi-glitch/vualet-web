...
export function magicLinkEmail(link: string): { subject: string; html: string; text: string } {
  ...
  const text =
    ...
    `If you didn't request this, you can ignore this email.\n\nMira — a Vualet product, operated by Afaq Alnaseem Trading LLC.`;
  ...
  <div style="max-width:480px;margin:0 auto;padding:40px 24px">
    ...
    <p style="font-size:12px;color:#a49fa9;margin:28px 0 0">If you didn't request this, you can safely ignore this email.<br>Mira — a Vualet product, operated by Afaq Alnaseem Trading LLC.</p>
  </div></body></html>`;
