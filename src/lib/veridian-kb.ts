...
export const VERIDIAN_KB: KbEntry[] = [
  {
    topic: "What Mira is",
    body:
      "Mira is an AI assistant you talk to inside the chat apps you already use — WhatsApp and Telegram. There is no separate app to install and no new phone number to manage. You message Mira like you would message a person, by voice or by text, and it helps you get things done.",
  },
  {
    topic: "Voice on WhatsApp and Telegram",
    body:
      "Mira is voice-first. You can send it a voice note on WhatsApp or Telegram and it understands you and can reply naturally, in your own language. Because it lives in the chat you already use, there is nothing new to learn.",
  },
  {
    topic: "Multilingual voice — a headline strength",
    body:
      "Mira speaks many languages, out loud, with real emotion — not a flat robotic read, but warmth, tone, and feeling. You can talk to it by voice on WhatsApp and Telegram in your own language and it replies in kind, sounding human. Multilingual, emotional voice is one of Mira's headline strengths: it meets you where you are, in the language you think in.",
  },
  {
  ...
  {
    topic: "Company — Mira by Primaion",
    body:
      "Mira is a product by Primaion, operated by Afaq Alnaseem Trading LLC, and powered by Veridian — its proprietary technology. It is backed by Satellite World Electronics, a pioneer in dormant and local AI. Mira's focus is a private, trustworthy assistant that lives in the chats people already use.",
  },
  {
...
export function kbFallbackAnswer(message: string): string | null {
  ...
  if (has("language", "languages", "multilingual", "bilingual", "accent", "arabic", "spanish", "french", "translate")) {
    return "Mira speaks many languages out loud, with real emotion — warm and human, not robotic. Talk to it by voice on WhatsApp or Telegram in your own language and it replies in kind. Multilingual, emotional voice is one of its headline strengths.";
  }
  if (has("voice", "whatsapp", "telegram", "call", "speak")) {
    return "Mira is voice-first and lives in WhatsApp and Telegram — no new app and no new number. You can send it voice notes in your own language, and it replies out loud with real emotion in many languages.";
  }
  ...
  if (has("company", "who made", "primaion", "afaq", "veridian", "satellite", "backed", "story", "about")) {
    return "Mira is a product by Primaion, operated by Afaq Alnaseem Trading LLC, and powered by Veridian — its proprietary technology. It's backed by Satellite World Electronics, a pioneer in dormant and local AI.";
  }
  ...
  if (has("what is", "what's mira", "what can", "what does", "help", "hello", "hi ", "hey")) {
    return "Mira is an AI assistant you talk to inside WhatsApp and Telegram — voice-first, with a photographic memory for your world, that answers from what it actually knows. Ask me about voice, memory, OCR, small builds, pricing, or the company.";
  }
  return null;
}
